...
public class ItemListWidget {
    public static class Entry extends ListWidget.Entry<Entry> {
        ...
        @Override
        public void render(int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovering, float delta) {
            ...
            super.render(index, y, x, entryWidth, entryHeight, mouseX, mouseY, hovering, delta);
        }
    }
}
